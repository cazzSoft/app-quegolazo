...
namespace Skor.Models.JUEGOS
{
	...
	{
        private string connectionString = "data source=crms.database.windows.net;initial catalog=skor-2021-10-6-12-5;persist security info=True;user id=crms;password=vertice.123;MultipleActiveResultSets=True;App=EntityFramework&quot;";
