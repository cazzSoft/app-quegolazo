		...
		public Clases.cResultado JuegoPagoIngreso(Clases.cJuegoPagos _item)
		{
			...
			try
			{
				...
				using (System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("apuestas.a2022_Apuestas_JuegoPagos_Ingreso", conn))
				{
					...
					cmd.Parameters.Add(new System.Data.SqlClient.SqlParameter("@IdUsuario", _item.idPersona));
					cmd.Parameters.Add(new System.Data.SqlClient.SqlParameter("@IdJuego", _item.idPersona));
					cmd.Parameters.Add(new System.Data.SqlClient.SqlParameter("@Valor", _item.idPersona));
					cmd.Parameters.Add(new System.Data.SqlClient.SqlParameter("@IdU", _item.idPersona));
